...
SIGNAL \inst7|inst5~q\ : std_logic;
SIGNAL \inst7|inst19~combout\ : std_logic;
...
SIGNAL \inst9|inst6~feeder_combout\ : std_logic;
...
SIGNAL \inst9|inst1~feeder_combout\ : std_logic;
...
SIGNAL \inst6|inst4~2_combout\ : std_logic;
SIGNAL \inst8|ALT_INV_inst19~combout\ : std_logic;
SIGNAL \inst8|ALT_INV_inst16~combout\ : std_logic;
SIGNAL \inst7|ALT_INV_inst19~combout\ : std_logic;
SIGNAL \inst7|ALT_INV_inst16~combout\ : std_logic;
SIGNAL \inst9|ALT_INV_inst19~0_combout\ : std_logic;
SIGNAL \inst9|ALT_INV_inst5~combout\ : std_logic;
...
SIGNAL \inst2|ALT_INV_inst7~0_combout\ : std_logic;
SIGNAL \inst2|ALT_INV_inst20~1_combout\ : std_logic;
SIGNAL \inst2|ALT_INV_inst20~0_combout\ : std_logic;
SIGNAL \inst2|ALT_INV_inst10~combout\ : std_logic;
...
\inst7|ALT_INV_inst19~combout\ <= NOT \inst7|inst19~combout\;
\inst7|ALT_INV_inst16~combout\ <= NOT \inst7|inst16~combout\;
\inst9|ALT_INV_inst19~0_combout\ <= NOT \inst9|inst19~0_combout\;
\inst9|ALT_INV_inst5~combout\ <= NOT \inst9|inst5~combout\;
...
\inst2|ALT_INV_inst7~0_combout\ <= NOT \inst2|inst7~0_combout\;
\inst2|ALT_INV_inst20~1_combout\ <= NOT \inst2|inst20~1_combout\;
\inst2|ALT_INV_inst20~0_combout\ <= NOT \inst2|inst20~0_combout\;
\inst2|ALT_INV_inst10~combout\ <= NOT \inst2|inst10~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_inst10~combout\,
	devoe => ww_devoe,
	o => \smc~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_inst20~0_combout\,
	devoe => ww_devoe,
	o => \smd~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_inst20~1_combout\,
	devoe => ww_devoe,
	o => \sme~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_inst7~0_combout\,
	devoe => ww_devoe,
	o => \smf~output_o\);
...
-- Equation(s):
-- \inst7|inst13~combout\ = LCELL(\SET_S~input_o\ $ (\CLK~input_o\))
...
-- Equation(s):
-- \inst7|inst16~combout\ = (\RESET~input_o\ & !\inst7|inst18~combout\)
...
-- Equation(s):
-- \inst7|inst5~0_combout\ = !\inst7|inst5~q\
...
PORT MAP (
	clk => \inst7|inst~q\,
	d => \inst7|inst5~0_combout\,
	clrn => \inst7|ALT_INV_inst19~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst7|inst5~q\);

-- Location: LCCOMB_X73_Y72_N22
\inst7|inst19\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst7|inst19~combout\ = (\RESET~input_o\ & ((\inst7|inst~q\) # (\inst7|inst5~q\)))
...
-- Equation(s):
-- \inst8|inst13~combout\ = LCELL(\SET_M~input_o\ $ (((\inst7|inst~q\) # (\inst7|inst5~q\))))
...
-- Equation(s):
-- \inst8|inst18~combout\ = LCELL((!\inst8|inst1~q\ & !\inst8|inst3~q\))
...
-- Equation(s):
-- \inst8|inst19~combout\ = (\RESET~input_o\ & ((\inst8|inst5~q\) # (\inst8|inst~q\)))
...
-- Equation(s):
-- \inst9|inst13~combout\ = LCELL(\SET_H~input_o\ $ (((\inst8|inst~q\) # (\inst8|inst5~q\))))
...
\inst9|inst6~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst9|inst6~feeder_combout\ = \inst9|inst6~0_combout\
...
PORT MAP (
	...
	combout => \inst9|inst6~feeder_combout\);
...
PORT MAP (
	...
	clrn => \inst9|ALT_INV_inst5~combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst9|inst2~q\);
...
\inst9|inst5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst9|inst5~combout\ = (\RESET~input_o\ & (!\inst9|inst18~combout\ & ((\inst9|inst2~q\) # (\inst9|inst~q\))))
...
\inst9|inst1~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst9|inst1~feeder_combout\ = \inst9|inst1~0_combout\
...
PORT MAP (
	...
	combout => \inst9|inst1~feeder_combout\);
...
-- Equation(s):
-- \inst9|inst18~combout\ = LCELL((!\inst9|inst1~q\ & !\inst9|inst3~q\))
...
-- Equation(s):
-- \inst9|inst19~0_combout\ = (\RESET~input_o\ & ((\inst9|inst~q\) # (\inst9|inst2~q\)))
...
PORT MAP (
	...
	clrn => \inst9|ALT_INV_inst19~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst9|inst4~q\);
...
\inst9|inst20\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst9|inst20~combout\ = (!\inst9|inst~q\ & !\inst9|inst2~q\)
...
-- Equation(s):
-- \inst1|inst4~0_combout\ = ((\inst7|inst6~q\ $ (!\inst7|inst2~q\)) # (!\inst7|inst1~q\)) # (!\inst7|inst3~q\)
...
-- Equation(s):
-- \inst1|inst6~combout\ = (\inst7|inst2~q\) # (\inst7|inst6~q\ $ (!\inst7|inst1~q\))
...
-- Equation(s):
-- \inst1|inst20~0_combout\ = ((\inst7|inst6~q\ & ((\inst7|inst2~q\) # (!\inst7|inst1~q\))) # (!\inst7|inst6~q\ & (\inst7|inst1~q\ $ (\inst7|inst2~q\)))) # (!\inst7|inst3~q\)
...
-- Equation(s):
-- \inst1|inst7~0_combout\ = ((\inst7|inst1~q\ & ((\inst7|inst6~q\) # (!\inst7|inst2~q\))) # (!\inst7|inst1~q\ & (\inst7|inst6~q\ & !\inst7|inst2~q\))) # (!\inst7|inst3~q\)
...
-- Equation(s):
-- \inst1|inst9~0_combout\ = ((\inst7|inst1~q\ & ((!\inst7|inst2~q\))) # (!\inst7|inst1~q\ & ((\inst7|inst6~q\) # (\inst7|inst2~q\)))) # (!\inst7|inst3~q\)
...
-- Equation(s):
-- \inst2|inst4~0_combout\ = (\inst7|inst5~q\ $ (!\inst7|inst4~q\)) # (!\inst7|inst~q\)
...
-- Equation(s):
-- \inst2|inst6~combout\ = (\inst7|inst5~q\) # (\inst7|inst4~q\ $ (!\inst7|inst~q\))
...
\inst2|inst10\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|inst10~combout\ = ((\inst7|inst~q\) # (!\inst7|inst4~q\)) # (!\inst7|inst5~q\)
...
\inst2|inst20~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|inst20~0_combout\ = (\inst7|inst5~q\ & ((\inst7|inst4~q\) # (!\inst7|inst~q\))) # (!\inst7|inst5~q\ & (\inst7|inst4~q\ $ (\inst7|inst~q\)))
...
\inst2|inst20~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|inst20~1_combout\ = (\inst7|inst4~q\ & ((\inst7|inst5~q\) # (!\inst7|inst~q\)))
...
-- Equation(s):
-- \inst2|inst7~0_combout\ = (\inst7|inst5~q\ & (\inst7|inst4~q\ & \inst7|inst~q\)) # (!\inst7|inst5~q\ & ((\inst7|inst4~q\) # (\inst7|inst~q\)))
...
-- Equation(s):
-- \inst2|inst9~0_combout\ = (\inst7|inst5~q\ & ((!\inst7|inst~q\))) # (!\inst7|inst5~q\ & ((\inst7|inst4~q\) # (\inst7|inst~q\)))
...
-- Equation(s):
-- \inst3|inst4~0_combout\ = ((\inst8|inst2~q\ $ (!\inst8|inst6~q\)) # (!\inst8|inst3~q\)) # (!\inst8|inst1~q\)
...
-- Equation(s):
-- \inst3|inst6~combout\ = (\inst8|inst2~q\) # (\inst8|inst1~q\ $ (!\inst8|inst6~q\))
...
-- Equation(s):
-- \inst3|inst10~combout\ = (\inst8|inst1~q\) # ((!\inst8|inst2~q\) # (!\inst8|inst6~q\))
...
-- Equation(s):
-- \inst3|inst20~0_combout\ = ((\inst8|inst2~q\ & ((\inst8|inst6~q\) # (!\inst8|inst1~q\))) # (!\inst8|inst2~q\ & (\inst8|inst1~q\ $ (\inst8|inst6~q\)))) # (!\inst8|inst3~q\)
...
-- Equation(s):
-- \inst3|inst5~0_combout\ = (\inst8|inst6~q\ & ((\inst8|inst2~q\) # (!\inst8|inst1~q\)))
...
-- Equation(s):
-- \inst3|inst7~0_combout\ = ((\inst8|inst2~q\ & (\inst8|inst1~q\ & \inst8|inst6~q\)) # (!\inst8|inst2~q\ & ((\inst8|inst1~q\) # (\inst8|inst6~q\)))) # (!\inst8|inst3~q\)
...
-- Equation(s):
-- \inst3|inst9~0_combout\ = ((\inst8|inst2~q\ & (!\inst8|inst1~q\)) # (!\inst8|inst2~q\ & ((\inst8|inst1~q\) # (\inst8|inst6~q\)))) # (!\inst8|inst3~q\)
...
-- Equation(s):
-- \inst4|inst4~0_combout\ = (\inst8|inst4~q\ $ (!\inst8|inst5~q\)) # (!\inst8|inst~q\)
...
-- Equation(s):
-- \inst4|inst6~combout\ = (\inst8|inst5~q\) # (\inst8|inst~q\ $ (!\inst8|inst4~q\))
...
-- Equation(s):
-- \inst4|inst10~combout\ = ((\inst8|inst~q\) # (!\inst8|inst4~q\)) # (!\inst8|inst5~q\)
...
-- Equation(s):
-- \inst4|inst20~0_combout\ = (\inst8|inst5~q\ & ((\inst8|inst4~q\) # (!\inst8|inst~q\))) # (!\inst8|inst5~q\ & (\inst8|inst~q\ $ (\inst8|inst4~q\)))
...
-- Equation(s):
-- \inst4|inst20~1_combout\ = (\inst8|inst4~q\ & ((\inst8|inst5~q\) # (!\inst8|inst~q\)))
...
-- Equation(s):
-- \inst4|inst7~0_combout\ = (\inst8|inst5~q\ & (\inst8|inst~q\ & \inst8|inst4~q\)) # (!\inst8|inst5~q\ & ((\inst8|inst~q\) # (\inst8|inst4~q\)))
...
-- Equation(s):
-- \inst4|inst9~0_combout\ = (\inst8|inst5~q\ & (!\inst8|inst~q\)) # (!\inst8|inst5~q\ & ((\inst8|inst~q\) # (\inst8|inst4~q\)))
...
-- Equation(s):
-- \inst5|inst4~0_combout\ = ((\inst9|inst4~q\ $ (!\inst9|inst6~q\)) # (!\inst9|inst1~q\)) # (!\inst9|inst2~q\)
...
-- Equation(s):
-- \inst5|inst6~combout\ = (\inst9|inst6~q\) # (\inst9|inst2~q\ $ (!\inst9|inst4~q\))
...
-- Equation(s):
-- \inst5|inst10~combout\ = (\inst9|inst2~q\) # ((!\inst9|inst6~q\) # (!\inst9|inst4~q\))
...
-- Equation(s):
-- \inst5|inst20~0_combout\ = ((\inst9|inst6~q\ & ((\inst9|inst4~q\) # (!\inst9|inst2~q\))) # (!\inst9|inst6~q\ & (\inst9|inst2~q\ $ (\inst9|inst4~q\)))) # (!\inst9|inst1~q\)
...
-- Equation(s):
-- \inst5|inst5~0_combout\ = (\inst9|inst4~q\ & ((\inst9|inst6~q\) # (!\inst9|inst2~q\)))
...
-- Equation(s):
-- \inst5|inst7~0_combout\ = ((\inst9|inst2~q\ & ((\inst9|inst4~q\) # (!\inst9|inst6~q\))) # (!\inst9|inst2~q\ & (\inst9|inst4~q\ & !\inst9|inst6~q\))) # (!\inst9|inst1~q\)
...
-- Equation(s):
-- \inst5|inst9~0_combout\ = ((\inst9|inst6~q\ & (!\inst9|inst2~q\)) # (!\inst9|inst6~q\ & ((\inst9|inst2~q\) # (\inst9|inst4~q\)))) # (!\inst9|inst1~q\)
...
-- Equation(s):
-- \inst6|inst4~0_combout\ = (\inst9|inst3~q\ & !\inst9|inst~q\)
...
\inst6|inst4~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst6|inst4~1_combout\ = (!\inst9|inst3~q\ & \inst9|inst~q\)
...
\inst6|inst4~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst6|inst4~2_combout\ = (!\inst9|inst~q\) # (!\inst9|inst3~q\)
